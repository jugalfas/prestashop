...
<div class="configure-area">
    ...
    <form action="#" id="kd_form">
                            ...
                            <div class="dropdown_error">
                                {* <a class="btn btn-select dropdown">
                                    ...
                                    <select class="btn btn-select btn-select-value select_box_for_url {$t.variable_name}"
                                        ...
                                        data-formula-name="{$t.formula_name}"
                                        data-url_variable="{str_replace(' ', '_', strtolower($t.variable_name))}"
                                        style="text-align:left" data-label-text="{$t.name|escape:'html':'UTF-8'}">
        ...
        {*  commented to hide the unit price 
         <div class="heading-frm-sec">
            <div class="heading-frm-sec-left"> {l s='Selected configureren' mod='productpriceconfig'}</div>
            <div class="heading-frm-sec-right">{l s='Unit price' mod='productpriceconfig'}</div>
          </div>

          <div class="frm-section unit_prices">
            <div class="unit_price">
                <div class="left-frm-section"></div>
                <div class="right-frm-section-price">$0.0000</div>
            </div>
          </div>
       *}
        ...
        <div class="frm-section package_count__wrapper">
            <div class="left-frm-section">{l s='Total Package' mod='productpriceconfig'}</div>
            <div class="right-frm-section-price package_count">1</div>
        </div>
        <div class="frm-section">
        ...
        <div class="frm-section">
            <div class="calculate-price-green">
                ...
                <div class="customize-area">
                    ...
                    {l s='Upload Now' mod='web2print'} <i class="fa fa-spinner fa-spin text-white font-30"
