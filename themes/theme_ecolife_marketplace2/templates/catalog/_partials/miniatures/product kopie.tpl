 ...
 {if $postheme.grid_type == 0}
	...
	<article class="pos-featured-products style_product_default product-miniature js-product-miniature item_in" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
		...
		<div class="img_block">
			...
			<div class="product_desc">
				...
				{block name='product_description_short'}
					<div class="product-desc" itemprop="description">{$product.description_short|truncate:200:'...' nofilter}</div>
				{/block}
			...
			<div class="button-container"> <a itemprop="url" class="button lnk_view btn btn-default" href="{$product.url}" title="{l s='Add to cart' d='Shop.Theme.Actions'}"> <span>{l s='Add to cart' d='Shop.Theme.Actions'}</span> </a></div>
		</article>
	{/block}
