...
{block name='content'}
  ...
  <section id="main" itemscope itemtype="https://schema.org/Product">
      ...
      <div class="{if $postheme.product_thumbnail == 0}col-md-6 {else} col-md-6 {/if}">
        ...
        <div class="content_info">
          ...
          <div class="product-rating--wrapper">
            ...
            <etrusted-product-review-list-widget-product-star-extension style="display: block; width: 110px; margin-top: 15px;"></etrusted-product-review-list-widget-product-star-extension>
          ...
          <div class="content_info">
            ...
            <div class="product-information">
              ...
              {if $product.is_customizable && count($product.customizations.fields)}
                  ...
                  {/block}
              {else}
                <p style="color:red; display:none;">VOOR HOOK</p>
                {hook h='displayOnlyprintProbo' product=$product}
                <p style="color:red; display:none;">NA HOOK</p>
              {/if}
	...
	<div class="row product_tabs_wrapper">
		<div class="col-xs-12">
