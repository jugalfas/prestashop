					...
					<div class="dropdown_error">
						{* <a class="btn btn-select dropdown">
							<input type="hidden" class="btn-select-input input_for_url" id="{$t.variable_name}"
								...
								data-variable_id="{$t.id_variable}" data-variable-name="{$t.variable_name}" data-product_variable_id="{$t.id_product_variable|intval}"
								data-formula-name="{$t.formula_name}"
								data-url_variable="{str_replace(' ', '_', strtolower($t.variable_name))}"
								data-type="{$t.type}">
							<span class="btn-select-value {$t.variable_name}" data-variable_id="{$t.id_variable}" data-product_variable_id="{$t.id_product_variable|intval}"
							...
							<select class="btn btn-select btn-select-value select_box_for_url {$t.variable_name}"
								...
								<option data-id_option="{$option.id}" data-price="{$option.price}"
									data-weight="{$option.weight}" data-thickness="{$option.thickness}"  {if $option.id==$t.default_option} selected class="selected"
									{/if} data-option_id="{$option.id}" value="{$option.id}">{$option.name}</option>
								{/foreach}
							</select>
							{*
						</a> *}
