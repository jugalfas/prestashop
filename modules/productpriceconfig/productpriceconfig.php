...
class ProductPriceConfig extends Module
{
    ...
    public function fcCreate()
    {
        ...
        $apply_type = 'total';//Tools::getValue('apply_type');
     ...
     */
    private function calculateFormulaConditionSurcharge($conditions, $id_vari, $value, $value_price)
    {
        if (!$conditions) {
            return 0;
        }
