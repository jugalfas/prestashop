...
<div id="_desktop_user_info">
	...
	<div class="user_login_text"><p>{if $logged}
				<a href="{$my_account_url}" rel="nofollow" class="dropdown-item">{l s='My account' d='Shop.Theme.Customeraccount'}</a> {else}
				<a
					href="{$my_account_url}"
