                                                ...
                                                <div class="md-checkbox md-checkbox-inline">
                                                    <label>
                                                        <input type="checkbox" class="option-child-checkbox"
                                                            name="variables[{$var.code}][]"
                                                            value="{$optLabel|escape:'htmlall':'UTF-8'}" data-parent="{$var.code}"
                                                            checked />
...
{literal}
    <script>
        (function() {
            ...
            $(function() {
                bindParentChildLogic('.variable-parent-checkbox', '.option-child-checkbox', 'data-code',
                    'data-parent');
